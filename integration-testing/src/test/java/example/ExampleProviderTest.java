...
public class ExampleProviderTest {
    ...
    public void before() {
        initMocks(this);
        ExampleController exampleController = new ExampleController(personRepository, weatherClient);
    ...
    public void personData() {
        ...
        when(personRepository.findByLastName("Nayak")).thenReturn(Optional.of
                (name));
    }
}
